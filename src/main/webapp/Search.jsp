...
<body>
	...
	<section style="display: flex;">
		...
		<div style="flex: 1;">
			<div onmouseover="showGreeting()" onmouseout="hideGreeting()">
				...
				<form action="/project/DaySelectionServlet" method="POST">
					<div id="greeting"
						...
						<span onclick="selectDay('日'); document.forms[1].submit();"
							style="display: block; transform: rotate(-100deg); transform-origin: -30% 150%;">日</span>
						<span onclick="selectDay('月'); document.forms[1].submit();"
							style="display: block; transform: rotate(-60deg); transform-origin: 50% 150%;">月</span>
						<span onclick="selectDay('火'); document.forms[1].submit();"
							style="display: block; transform: rotate(-30deg); transform-origin: 100% 100%;">火</span>
						<span onclick="selectDay('水'); document.forms[1].submit();"
							style="display: block;">水</span> <span
							onclick="selectDay('木'); document.forms[1].submit();"
							style="display: block; transform: rotate(30deg); transform-origin: 0 0;">木</span>
						<span onclick="selectDay('金'); document.forms[1].submit();"
							style="display: block; transform: rotate(70deg); transform-origin: 0 0;">金</span>
						<span onclick="selectDay('土'); document.forms[1].submit();"
